...
- Два источника данных на выбор (Open-Meteo по умолчанию и OpenWeather).
- Гибкая настройка внешнего вида: иконки для каждого типа погоды, палитра времени суток, параметры солнечного слоя и детальная регулировка градиентов с интерактивным предпросмотром.
